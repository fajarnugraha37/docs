...
<a href="./learn-java-template-freemarker-thymeleaf-rendering-engineering-part-006.md">Part 6 — FreeMarker Macros, Functions, Custom Directives, and Reusable Template APIs ➡️</a>
</div>
